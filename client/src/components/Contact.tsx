      ...
      <div className="container relative z-10" ref={ref}>
        ...
        <div className="text-center mb-8 md:mb-12">
          <motion.span
            ...
            className="inline-block text-primary text-base font-black md:text-lg md:font-black tracking-[0.15em] md:tracking-[0.3em] mb-4 tagline-bold"
          >
            READY TO START?
          </motion.span>
          <motion.h2
        ...
        <motion.div
          ...
          className="flex flex-col lg:flex-row items-start md:items-center justify-center gap-6 md:gap-8 lg:gap-16 mx-auto pl-12 md:pl-0"
        >
          <a

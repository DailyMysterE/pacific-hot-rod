 ...
 * - Prominent, premium contact form
 * - Larger text sizes for better visibility
            ...
            >
              <div className="space-y-5">
                ...
                >
                  ...
                  <span className="text-base md:text-lg break-all">info@pacifichotrod.com</span>
                </a>
                <div className="flex items-center gap-4 text-foreground/70">
                  <div className="w-12 h-12 rounded-full bg-primary/10 border border-primary/30 flex items-center justify-center">
                    <MapPin className="w-5 h-5 text-primary" />
                  </div>
                  <span className="text-base md:text-lg">Langley, BC<br/>Greater Vancouver</span>
                </div>
              </div>
            </motion.div>

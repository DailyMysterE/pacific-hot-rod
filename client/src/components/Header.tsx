          ...
          <div className="hidden lg:flex items-center gap-1">
            {navLinks.map((link) => (
              <a
                ...
                className="font-display text-xs tracking-[0.2em] uppercase text-foreground/70 hover:text-foreground px-4 py-2 transition-all duration-300 relative group"
              >
                {link.label}
            ...
            <a
              ...
              className="font-display text-xs tracking-[0.15em] uppercase ml-4 bg-primary text-primary-foreground px-5 py-2.5 transition-all duration-300 hover:bg-primary/90 hover:shadow-lg hover:shadow-primary/30 border border-primary/50"
            >
              Get a Quote
            </a>
          </div>

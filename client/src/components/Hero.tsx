    ...
    <section id="home" className="relative h-screen flex items-center overflow-hidden">
      ...
      <div className="container relative z-10 pt-28 md:pt-40 pb-12 md:pb-20">
        <div className="max-w-2xl lg:max-w-3xl">
          ...
          >
            <span className="text-[1rem] font-black md:text-base md:font-black tracking-[0.03em] md:tracking-[0.15em] text-primary-light whitespace-nowrap tagline-bold">
          ...
          >
            <button
              ...
              className="group font-display text-sm md:text-base tracking-[0.15em] bg-primary text-primary-foreground px-8 py-3.5 md:px-12 md:py-5 hover:bg-primary/90 transition-all duration-300 hover:shadow-2xl hover:shadow-primary/30 hover:-translate-y-0.5" style={{ fontWeight: 700 }}
            >
              START YOUR PROJECT
            </button>
            <button
              onClick={scrollToGallery}
              className="font-display text-sm md:text-base tracking-[0.15em] border-2 border-foreground/20 text-foreground/80 px-8 py-3.5 md:px-12 md:py-5 hover:border-primary hover:text-primary hover:bg-primary/5 transition-all duration-300" style={{ fontWeight: 700 }}
            >
              VIEW OUR WORK
            </button>

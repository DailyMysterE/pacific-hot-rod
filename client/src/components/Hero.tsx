    ...
    <section id="home" className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="container relative z-10 pt-16 md:pt-24 pb-12 md:pb-20">
        <div className="max-w-2xl lg:max-w-3xl">
          ...
          >
            <span className="text-base font-bold md:text-lg md:font-semibold tracking-[0.15em] md:tracking-[0.25em] text-primary/90">
          ...
          >
            <button
              ...
              className="group font-display font-semibold text-xs md:text-base tracking-[0.15em] bg-primary text-primary-foreground px-8 py-3.5 md:px-12 md:py-5 hover:bg-primary/90 transition-all duration-300 hover:shadow-2xl hover:shadow-primary/30 hover:-translate-y-0.5"
            >
              START YOUR PROJECT
            </button>
            <button
              onClick={scrollToGallery}
              className="font-display font-semibold text-xs md:text-base tracking-[0.15em] border-2 border-foreground/20 text-foreground/80 px-8 py-3.5 md:px-12 md:py-5 hover:border-primary hover:text-primary hover:bg-primary/5 transition-all duration-300"
            >
              VIEW OUR WORK
            </button>
          ...
          >
            ...
            <div className="text-center">
              ...
              <div className="text-xs text-foreground/50 tracking-wider mt-0.5">YEARS EXPERIENCE</div>
            </div>
            <div className="h-px w-8 bg-primary/20" />
          </motion.div>
        </div>

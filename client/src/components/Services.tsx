        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-2 md:gap-5">
          {services.map((service, index) => (
            <motion.div
              ...
              className="group relative aspect-square bg-gradient-to-br from-[oklch(0.12_0.008_250)] to-[oklch(0.08_0.005_250)] border border-border/30 hover:border-primary/50 transition-all duration-500 flex items-center justify-center p-3 md:p-8 overflow-hidden"
            >
              ...
              {/* Title */}
              <h3 className="relative z-10 font-display text-xs md:text-2xl tracking-wider text-center text-foreground/70 group-hover:text-foreground transition-all duration-300 leading-tight">
                {service.toUpperCase()}
              </h3>
